...
I want to run predictive models in the future so using quanteda, I can easily transform the corpus from the document level into the paragraph level and keep the doc variables 
